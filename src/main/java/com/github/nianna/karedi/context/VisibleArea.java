...
public class VisibleArea implements IntBounded {
    ...
    private final ReadOnlyIntegerProperty minBeatProperty;

    private final ReadOnlyIntegerProperty maxBeatProperty;

    private final Area area;

    VisibleArea(ReadOnlyIntegerProperty minBeatProperty, ReadOnlyIntegerProperty maxBeatProperty) {
        this.minBeatProperty = minBeatProperty;
        this.maxBeatProperty = maxBeatProperty;
    ...
    private IntBounded getMaxVisibleArea() {
        return addMargins(
                BoundingBox.boundsFrom(
                        minBeatProperty.get(),
                        maxBeatProperty.get(),
                        MusicalScale.MIN_TONE,
                        MusicalScale.MAX_TONE
				)
        );
    }
