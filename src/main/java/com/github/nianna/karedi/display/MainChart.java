...
public class MainChart extends Region {
	...
	private void drawVerticalLines() {
		List<Double> verticalMarks = xAxis.getTickMarks().stream()
				.filter(tick -> tick.getValue().intValue() % 4 == 0)
				.mapToDouble(tick -> xAxis.getDisplayPosition(tick.getValue())).boxed()
